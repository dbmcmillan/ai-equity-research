...
ticker = "NET"
competitors_tickers = ["MSFT", "AMZN","GOOGL"]
#Check if 10Q summary already exists and use it if so
if os.path.exists(f"checkpoints/{ticker}_10Q_Summary.txt"):
    with open(f"checkpoints/{ticker}_10Q_Summary.txt", "r", encoding="utf-8") as f:
        summary_text_10Q = f.read()
    print("10-Q summary loaded from existing file.")
else:
    summary_text_10Q = summarize_document.summarize_document(ticker, "10Q", f"reports/{ticker}_10Q.pdf")
    time.sleep(120)
    print("10-Q summarization complete. Taking a 2-minute break...")

if os.path.exists(f"checkpoints/{ticker}_10K_Summary.txt"):
    with open(f"checkpoints/{ticker}_10K_Summary.txt", "r", encoding="utf-8") as f:
        summary_text_10K = f.read()
    print("10-K summary loaded from existing file.")
else:
    summary_text_10K = summarize_document.summarize_document(ticker, "10K", f"reports/{ticker}_10K.pdf")
    time.sleep(120) 
    print("10-K summarization complete. Taking a 2-minute break...")
if os.path.exists(f"checkpoints/{ticker}_earnings_Summary.txt"):
    with open(f"checkpoints/{ticker}_earnings_Summary.txt", "r", encoding="utf-8") as f:
        summary_text_earnings = f.read()
    print("Earnings call summary loaded from existing file.")
else:
    summary_text_earnings = summarize_document.summarize_document(ticker, "earnings", f"reports/{ticker}_earnings.docx")
...
if os.path.exists(f"checkpoints/{ticker}_Financials_Summary.txt"):
    with open(f"checkpoints/{ticker}_Financials_Summary.txt", "r", encoding="utf-8") as f:
    ...
    output_financials_path = f"checkpoints/{ticker}_Financials_Summary.txt"
...
if os.path.exists(f"reports/{ticker}_Drivers_Summary.txt"):
    with open(f"reports/{ticker}_Drivers_Summary.txt", "r", encoding="utf-8") as f:
    ...
    output_drivers_path = f"checkpoints/{ticker}_Drivers_Summary.txt"
...
if os.path.exists(f"reports/{ticker}_Projections_Table.csv"):
    with open(f"reports/{ticker}_Projections_Table.csv", "r", encoding="utf-8") as f:
    ...
    output_projections_path = f"reports/{ticker}_Projections_Table.csv"
...
output_valuation_path = f"reports/{ticker}_Valuation_Metrics.json"
...
analyst_notes_path = f"reports/{ticker}_Analyst_Notes.docx"
...
multiples_output_path = f"reports/{ticker}_and_Competitors_Multiples.csv"
...
if os.path.exists(f"reports/{ticker}_Sensitivity_Table.csv"):
    with open(f"reports/{ticker}_Sensitivity_Table.csv", "r", encoding="utf-8") as f:
...
sensitivity_output_path = f"checkpoints/{ticker}_Sensitivity_Table.csv"
...
if os.path.exists(f"checkpoints/{ticker}_Introduction_Section.txt"):
    with open(f"checkpoints/{ticker}_Introduction_Section.txt", "r", encoding="utf-8") as f:
    ...
    with open(f"checkpoints/{ticker}_Introduction_Section.txt", "w", encoding="utf-8") as f:
...
if os.path.exists(f"checkpoints/{ticker}_Industry_Investment_Section.txt"):
    with open(f"checkpoints/{ticker}_Industry_Investment_Section.txt", "r", encoding="utf-8") as f:
    ...
    with open(f"checkpoints/{ticker}_Industry_Investment_Section.txt", "w", encoding="utf-8") as f:
...
if os.path.exists(f"checkpoints/{ticker}_Financials_Risks_Section.txt"):
    with open(f"checkpoints/{ticker}_Financials_Risks_Section.txt", "r", encoding="utf-8") as f:
        third_two_sections = f.read()
    print("Financials and Risks section loaded from existing file.")
else:
    third_two_sections = financials_risks_agent(summary_text_10K, summary_text_10Q, summary_text_earnings, financials_summary, drivers_summary, projections_table, valuation_metrics, important_stock_metrics, additional_notes, first_two_sections, second_two_sections, sensitivity_table_str)
    with open(f"checkpoints/{ticker}_Financials_Risks_Section.txt", "w", encoding="utf-8") as f:  
...
if os.path.exists(f"checkpoints/{ticker}_ESG_Appendices_Section.txt"):
    with open(f"checkpoints/{ticker}_ESG_Appendices_Section.txt", "r", encoding="utf-8") as f:
    ...
    with open(f"checkpoints/{ticker}_ESG_Appendices_Section.txt", "w", encoding="utf-8") as f:
        f.write(remaining_sections)
        time.sleep(120)
print("Remaining sections of the report completed. Taking a 1-minute break...")
today_date = date.today()
equity_report = master_agent(first_two_sections, second_two_sections, third_two_sections, remaining_sections, today_date)
# Save the final equity research report
output_report_path = f"reports/{ticker}_Equity_Research_Report.md"
...
chart_output_path = f"reports/{ticker}_vs_SPY_chart.html"
...
combined_html_path = f"reports/{ticker}_Equity_Research_Report.html"
with open(combined_html_path, "w", encoding="utf-8") as f:
    ...
    with open(chart_output_path, "r", encoding="utf-8") as chart_file:
        ...
        f.write(chart_html)
pdf_output_path = f"reports/{ticker}_Equity_Research_Report.pdf"
